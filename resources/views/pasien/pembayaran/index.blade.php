            ...
            <div class="px-5 py-4 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    @if ($bukti && $bukti->isVerified())
                        ...
                        <img src="{{ Storage::url($bukti->file_bukti) }}" alt="Bukti Pembayaran"
                    ...
                    @else
                        {{-- Belum upload --}}
                        <div
                            class="border-2 border-dashed border-slate-300 rounded-xl p-5 text-center text-slate-400 mb-3">
                        ...
                        <form action="{{ route('pasien.pembayaran.upload', $periksa->id) }}" method="POST"
                            ...
                            <p class="text-xs text-slate-400 mb-2">Format: JPG, JPEG, PNG, atau WEBP, maks. 5MB</p>
                            <input type="file" name="file_bukti" accept=".jpg,.jpeg,.png,.webp" required
